...
![Git tags for constructor milestone](screenshots/git-tags-s1-s2.png)
...
![Unit tests](screenshots/unit-tests-display-2.png)
...
![Sensor unit tests](screenshots/sensor-tests.png)
...
> The test should be performed the CarPark unit tests, not in the Display or Sensor unit tests.
> 
Because

•	The register method is part of the CarPark class — it's CarPark's responsibility to enforce correct usage.

•	The test checks how CarPark behaves when it receives an unexpected object type. It's not the responsibility of the Sensor or Display classes to validate this.

•	Unit tests should focus on testing the behaviour of the class where the method is implemented, ensuring encapsulation and single responsibility.
